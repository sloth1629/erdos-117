...
- `h8_five_group_cutoff.g`: `[COMPUTED]` complete cutoff-eight inventory of
  all 781 SmallGroups of orders \(5^3,5^4,5^5,5^6\). It saves a verified
  nine-clique boundary witness or the complete central-coset adjacency for
  every group. The script SHA-256 is
  `b7201ee828a95a9d26264d7d0fab5d658b945e30dd6bf312ef908afa47f8975f`;
  it makes no classification claim beyond those four orders.
- `h8_three_group_cutoff.g`: `[COMPUTED]` complete cutoff-eight inventory of
  all 594 SmallGroups of orders \(3,3^2,\ldots,3^6\). It stores either a
  checked nine-clique product witness or the complete central-coset graph.
  The script SHA-256 is
  `138e6479414b6cd6c6610b771125a1e3788f92f7b2a9091f92238a2aaff858bb`;
  it makes no claim about the 9,310 unscanned groups of order \(3^7\).
...
The bounded finite 5-group inventory is regenerated by:
...
`[UNVERIFIED]` This configuration does not enumerate finite 5-groups above
order \(5^6\) and is not a classification of the unscanned orders.

The bounded finite 3-group inventory is regenerated by:
...
`[UNVERIFIED]` This configuration stops at order \(3^6=729\); it is a
bounded inventory, not the all-orders finite 3-group theorem proved
separately in `notes/three_group_nu8.md`.
